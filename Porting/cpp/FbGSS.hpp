...
/*
  ...
  DbGSS.Ts = 0.1;              // Шаг дискретизации по времени [с].
  DbGSS();                     // Генератор сигналов и псевдослучайных чисел.
  bool a = DbGSS.RectangleR;   // Прямоугольный сигнал вещественный.
  float b = DbGSS.RectangleB;  // Прямоугольный сигнал булевый.
*/
