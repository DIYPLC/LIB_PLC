...
class FORTE_FbEdgeNeg final : public CSimpleFB {
  DECLARE_FIRMWARE_FB(FORTE_FbEdgeNeg)
  ...
  public:
    FORTE_FbEdgeNeg(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
