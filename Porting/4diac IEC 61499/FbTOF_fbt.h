...
class FORTE_FbTOF final : public CSimpleFB {
  DECLARE_FIRMWARE_FB(FORTE_FbTOF)
  ...
  public:
    FORTE_FbTOF(CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
    ...
    void evt_REQ(const CIEC_BOOL &paIn, const CIEC_UDINT &paTimeDelayOff, const CIEC_UDINT &paTs_ms, CIEC_BOOL &paOut) {
      var_In = paIn;
    ...
    void operator()(const CIEC_BOOL &paIn, const CIEC_UDINT &paTimeDelayOff, const CIEC_UDINT &paTs_ms, CIEC_BOOL &paOut) {
      evt_REQ(paIn, paTimeDelayOff, paTs_ms, paOut);
    }
};
